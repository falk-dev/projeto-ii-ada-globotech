...
class Usuario:
     ...
     def obter_conteudos_unicos_consumidos(self) -> set: #retorna set de objetos 'conteúdo'
     ...
     def plataformas_mais_frequentes(self, top_n=3) -> list: #retorna as plataformas mais frequentes do usuário
         cont={}
     ...
     def __str__(self):
        ...
        return f"ID do Usuário:{self.__id_usuario}\nInterações:\n{interacoes_formatadas}"
